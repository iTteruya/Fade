...
public class GameInputProcessor implements InputProcessor {
    ...
    public GameInputProcessor(GameFieldController controller)
    {
    ...
    private int coordToIndex(float coord, boolean x) {
    ...
    private boolean trySwap(int screenX, int screenY, float swapDistance) {
